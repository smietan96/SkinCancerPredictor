namespace DatasetOrganizer
{
    public class Configuration
    {
        ...
        public Configuration(string basePath, string metadataFilePath, string sourceImagesPath1, string sourceImagesPath2, string trainImagesDir, string testImagesDir)
        {
            BasePath = basePath;
